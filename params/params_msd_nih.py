...
class Params:
    ...
    def trainparam():
        ...
        args.patch_nums = 8
        args.pad = 64
        args.oversample_foreground_percent = 0.8

        print(f'This experiment {args.exp} is for {args.del_mode} on {args.dataset}, running in gpu{args.gpu}')
